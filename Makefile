...
build-base-image:		## Build the base image for the 'python' workspace (default), or the workspace specified by setting the argument, IMAGE_NAME=<image_name>
...
build-jupyter-image:		## Build the jupyter image for the 'python' workspace (default), or the workspace specified by setting the argument, IMAGE_NAME=<image_name>
	@cd jupyterlab; \
	pwd; \
...
delete-image: delete-base-image delete-jupyter-image	## Delete the base and jupyter image for the 'python' workspace (default), or the workspace specified by setting the argument, IMAGE_NAME=<image_name>

delete-base-image:		## Delete the base image for the 'python' workspace (default), or the workspace specified by setting the argument, IMAGE_NAME=<image_name>
	docker image rm ${BASE_IMAGE_NAME}

delete-jupyter-image:		## Delete the jupyter image for the 'python' workspace (default), or the workspace specified by setting the argument, IMAGE_NAME=<image_name>
	docker image rm ${JUPYTER_IMAGE_NAME}

open-jupyter:		## Open a browser window to access an already running instance of a 'python' jupyter image, or the workspace specified by setting the argument, IMAGE_NAME=<image_name>
	open http://localhost:3100/

start-jupyter:		## Start the jupyter image for the 'python' workspace (default), or the workspace specified by setting the argument, IMAGE_NAME=<image_name>
