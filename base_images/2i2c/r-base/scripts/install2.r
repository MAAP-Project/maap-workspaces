...
# This file was extracted from this repository https://github.com/rocker-org/rocker-versioned2
# The license of this repository (rocker-versioned2) can be view here: 
# https://github.com/rocker-org/rocker-versioned2/blob/master/LICENSE

#    Warranty description we are required to convey: 
...
#    Any questions, please contact: grace.llewellyn@jpl.nasa.gov 
